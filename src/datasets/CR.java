...
public class CR {
	...
	public static String data_file_path = "./datasets/CR/" + ngram + "gram.txt";
	public static String w2v_file = "./datasets/CR/w2v.txt";
