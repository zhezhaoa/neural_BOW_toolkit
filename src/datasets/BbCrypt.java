...
public class BbCrypt {
	public static int ngram = 2;
	public static int nb = 1;
	public static int iter_num = 30;
	public static int n = 500;
	public static int neg_size = 30;
	public static String data_file_path = "./datasets/BbCrypt/"+ ngram + "gram.txt";
	public static String train_test_split = "./datasets/BbCrypt/train_test_split.txt";
	...
	public static Map<String, ArrayList<Sample>> getDataset() {
		...
		try {
			...
			String line = null;
			train_test_split_index = new int [1985];
			int counter = 0;
